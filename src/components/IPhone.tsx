...
import { Model as Phone } from "../constants";
...
function Model(props: Props) {
  ...
  const texture: Texture = useTexture(props.item.img) as Texture;

  useEffect(() => {
    Object.entries(materials).map((material) => {
      // Ini adalah nama material yang tidak dapat diubah warnanya
      if (
